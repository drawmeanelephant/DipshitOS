...
test "shell: mock-fed end-to-end session produces the exact transcript" {
    ...
    const expected =
        ...
        "  text        framebuffer text: text region, cursor, scrollback ('text put <string...>' renders + flushes to the scanout; 'text clear' clears; 'text fontdebug [on|off]' missing-glyph stats)\n" ++
