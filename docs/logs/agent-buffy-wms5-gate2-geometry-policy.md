# Log — `agent/buffy/wms5-gate2-geometry-policy`
...
- Claimed **WMS5 Gate 2 — geometry policy moves into WND.BIN (tile/snap/ws/min-max
  over the seam)** as `docs/claims/4278-wms5-gate2-geometry-policy.md` (status 🔄,
...
## 2026-08-29 — WMS5 Gate 2 complete (claim 4278)
