...
- **2026-08-07** — *buffy (freebuff/ragshit-impact)*: claim 0017 — Ragshit `impact` Git-aware reviewer context; claim filed; scope boundary `tools/ragshit/` only; plan in `artifacts/impact-plan.md` · 🔄 in progress
