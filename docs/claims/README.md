...
| [4354-m23-m24-gate-evidence](4354-m23-m24-gate-evidence.md) | buffy (`agent/buffy/m23-m24-gate-sweep`) | 🔄 partially done |
...
| [8777-m21-window-gate-sweep](8777-m21-window-gate-sweep.md) | t3code (`t3code/milestone-nine-triage`) | 🔄 t3code/milestone-nine-triage — W1+W2 live-gated ✅ (2026-08-25); W3–W16 sweep continues |
