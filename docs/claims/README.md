...
| [0194-img4-wallpaper](0194-img4-wallpaper.md) | antigravity (`agent/antigravity/img4-wallpaper`) | ✅ agent/antigravity/img4-wallpaper |
...
| [0365-tracker-sync-new-cards](0365-tracker-sync-new-cards.md) | buffy (`freebuff/okay-shower-thoughts-here-we-re-using-fat32-for-so-b0ce3067-2b04-4b81-984d-9fd76bfcf123`) | ✅ done |
...
| [1263-line-of-sight-board-sync](1263-line-of-sight-board-sync.md) | buffy (`freebuff/okay-shower-thoughts-here-we-re-using-fat32-for-so-b0ce3067-2b04-4b81-984d-9fd76bfcf123`) | ✅ done |
...
| [1312-m34-hf7-clone-dedup](1312-m34-hf7-clone-dedup.md) | buffy (`freebuff/get-git-up-to-date-there-were-quite-a-few-things-d-fe3ff43a-1217-4ca3-a9ad-b6faa6fbe86f`) | ✅ done — live gate PASS 6/6 (run 6, 2026-09-02), measurement artifact under `artifacts/m34-hf7-measurement.txt`; flake #810 filed (boot EL0 probe hang/park, 8/24 boots this session, retried in-gate) |
...
| [1432-m34-hf6-exec-flake803-rootcause1](1432-m34-hf6-exec-flake803-rootcause1.md) | buffy (`agent/buffy/m34-flake803`) | 🔄 agent/buffy/m34-flake803 |
...
| [1732-fix-desktop-manifest-count](1732-fix-desktop-manifest-count.md) | buffy (`agent/buffy/fix-desktop-manifest-count`) | ✅ done — both gates PASS 1/1 on VZ (`desktop: manifest apps=19` |
...
| [1840-z1f-enums](1840-z1f-enums.md) | buffy (`agent/buffy/z1f-enums`) | ✅ done |
...
| [2188-tee-drain-exit](2188-tee-drain-exit.md) | buffy (`agent/buffy/tee-drain-exit`) | ✅ |
...
| [2293-wasm-board-review-sync](2293-wasm-board-review-sync.md) | buffy (`freebuff/okay-shower-thoughts-here-we-re-using-fat32-for-so-b0ce3067-2b04-4b81-984d-9fd76bfcf123`) | ✅ done |
...
| [2369-serial-lock-smp-user](2369-serial-lock-smp-user.md) | buffy (`agent/buffy/serial-lock-smp-user`) | ✅ done |
...
| [2792-svclock-per-domain](2792-svclock-per-domain.md) | buffy (`agent/buffy/serial-lock-smp-user`) | ✅ done |
...
| [3082-m34-hf5-user-data-migration](3082-m34-hf5-user-data-migration.md) | buffy (`agent/buffy/m34-hf5-user-data-migration`) | ✅ — done 2026-09-01 (PR #792, branch merged; issue #739 |
...
| [3456-w3-import-breadth](3456-w3-import-breadth.md) | buffy (`freebuff/okay-shower-thoughts-here-we-re-using-fat32-for-so-b0ce3067-2b04-4b81-984d-9fd76bfcf123`) | ✅ done — merged (PR #807) |
...
| [3997-z2a-heap](3997-z2a-heap.md) | buffy (`agent/buffy/z2a-heap`) | ✅ done |
...
| [4574-img5-view](4574-img5-view.md) | buffy (`agent/buffy/img5-view`) | ✅ agent/buffy/img5-view |
| [4780-m34-hf6-fat-removal](4780-m34-hf6-fat-removal.md) | buffy (`agent/buffy/m34-hf6-fat-removal`) | ✅ done — implementation + representative live sweep green; flake #803 filed separately (see log) |
...
| [4912-vm-teardown-tail](4912-vm-teardown-tail.md) | buffy (`agent/buffy/vm-teardown-tail`) | ✅ |
...
| [5101-lane0b-fixture-drift](5101-lane0b-fixture-drift.md) | t3code (`t3code/b2feefd3`) | ✅ done |
...
| [5514-dq1-godmenu-completion](5514-dq1-godmenu-completion.md) | t3code (`agent/t3code/dq1-godmenu`) | ✅ agent/t3code/dq1-godmenu (merged PR #844, issue #836 closed) |
...
| [6351-m36-raster-ui](6351-m36-raster-ui.md) | antigravity (`agent/antigravity/raster-graphics-ui`) | ✅ agent/antigravity/raster-graphics-ui |
| [6366-vl6-gui-consumer](6366-vl6-gui-consumer.md) | antigravity (`agent/antigravity/vl6-gui-consumer`) | ✅ agent/antigravity/vl6-gui-consumer |
...
| [6461-w1b-interpreter](6461-w1b-interpreter.md) | buffy (`freebuff/okay-shower-thoughts-here-we-re-using-fat32-for-so-b0ce3067-2b04-4b81-984d-9fd76bfcf123`) | ✅ done (PR #794) |
| [6479-m19-sexiburger-god-menu](6479-m19-sexiburger-god-menu.md) | antigravity (`agent/antigravity/sexiburger`) | ✅ closed (2026-09-02) |
...
| [6562-dq2-tab-chrome-render](6562-dq2-tab-chrome-render.md) | t3code (`agent/t3code/dq2-tab-chrome`) | ✅ agent/t3code/dq2-tab-chrome (merged PR #847; card #840 stays open pending pixel proof) |
...
| [6823-z1e-control-flow](6823-z1e-control-flow.md) | antigravity (`agent/antigravity/z1e-control-flow`) | ✅ done |
| [6854-desktop-manifest-21](6854-desktop-manifest-21.md) | t3code (`agent/t3code/729-desktop-manifest-21`) | ✅ done 2026-09-02 — `verify-live-desktop` PASS on VZ at HEAD+patch; `verify-coordination` ok |
...
| [7129-w1a-import-contract](7129-w1a-import-contract.md) | t3code (`t3code/1145c9b5`) | ✅ done |
| [7154-issue-821-godmenu](7154-issue-821-godmenu.md) | antigravity (`agent/antigravity/desktop-quality-821`) | ✅ agent/antigravity/desktop-quality-821 |
...
| [7317-view-png](7317-view-png.md) | buffy (`agent/buffy/img5-png`) | ✅ agent/buffy/img5-png |
| [7395-m35-w4-core-completeness](7395-m35-w4-core-completeness.md) | buffy2 (`agent/buffy2/m35-w4-core-completeness`) | ✅ DONE 2026-09-02 — floats (f32/f64 + conversions/reinterpret, IEEE trap discipline; plain trunc 0xA8–0xB1 traps, 0xFC 0–7 trunc_sat clamps), sign-extension proof fixture, bulk-memory 0xFC 8–11 (justified by clang probe; DataCount + passive data); named C float utility `tests/floatapp.c` pinned (c963d5aa) and byte-exact live-gated (590-byte output, exit 590). Branch: the slice |
...
| [8326-sexiburger-standalone-component](8326-sexiburger-standalone-component.md) | antigravity (`agent/antigravity/sexiburger`) | ✅ agent/antigravity/sexiburger |
| [8459-m37-desktop-quality-scoping](8459-m37-desktop-quality-scoping.md) | t3code (`t3code/bfd813db`) | ✅ t3code/bfd813db |
| [8477-percore-scheduler-state](8477-percore-scheduler-state.md) | buffy (`agent/buffy/percore-scheduler-state`) | ✅ done |
| [8482-wms2-wmctl-register-seam](8482-wms2-wmctl-register-seam.md) | buffy (`agent/buffy/wms2-wmctl-register`) | ✅ done |
| [8513-audit-percore-counters](8513-audit-percore-counters.md) | buffy (`agent/buffy/audit-percore-counters`) | ✅ done |
| [8554-flake814-shell-park-stack](8554-flake814-shell-park-stack.md) | buffy (`freebuff/https-github-com-drawmeanelephant-dipshitos-issues-281dbccf-094a-4d25-8cc5-156e51271c8c`) | ✅ done |
| [8605-dq3-tab-mouse-interaction](8605-dq3-tab-mouse-interaction.md) | t3code (`agent/t3code/dq3-tab-interact`) | 🔄 agent/t3code/dq3-tab-interact |
| [8708-z1a-data-segment](8708-z1a-data-segment.md) | antigravity (`agent/antigravity/z1a-data-segment`) | 🔄 agent/antigravity/z1a-data-segment |
...
| [8956-z05-dialect-contract](8956-z05-dialect-contract.md) | antigravity (`agent/antigravity/z05-dialect-contract`) | ✅ agent/antigravity/z05-dialect-contract |
...
| [9094-fix-810-boot-probe-flake](9094-fix-810-boot-probe-flake.md) | buffy (`freebuff/get-git-up-to-date-there-were-quite-a-few-things-d-fe3ff43a-1217-4ca3-a9ad-b6faa6fbe86f`) | ✅ done — RESOLVED by the #850 fix (same branch, 2026-09-03): |
...
| [9408-lift-tick-gate](9408-lift-tick-gate.md) | buffy (`agent/buffy/percore-scheduler-state`) | ✅ done |
| [9459-m34-hf3-mutation](9459-m34-hf3-mutation.md) | buffy (`agent/buffy/m34-hf3-mutation`) | ✅ done |
| [9498-usergate-anycore](9498-usergate-anycore.md) | buffy (`agent/buffy/serial-lock-smp-user`) | ✅ done |
...
| [9685-z1b-arrays](9685-z1b-arrays.md) | t3code (`t3code/b5bdb1b1`) | ✅ t3code/b5bdb1b1 |
