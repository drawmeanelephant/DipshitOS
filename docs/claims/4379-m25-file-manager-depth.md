...
- **Touches:** kernel/src/monitor.zig, kernel/src/shell.zig, tests/transcript-console.txt, tools/verify-live-filemanager-du.sh, docs/march-m25.md, docs/status.md, docs/claims/4379-m25-file-manager-depth.md, docs/claims/2539-m25-lane-b-mkdir-du-recent.md, docs/logs/agent-buffy-m25-file-manager-depth.md
- **Depends on:** —
