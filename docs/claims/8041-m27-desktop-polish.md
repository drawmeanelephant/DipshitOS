...
- **Touches:** `kernel/src/fat.zig`, `kernel/src/monitor.zig`, `kernel/src/driving_award.zig`, `kernel/src/settings.zig`, `kernel/src/shell.zig`, `tests/transcript-console.txt`, `user/src/lib/ui.zig`, `user/src/settings_panel.zig`, `user/src/sysmon.zig`, `build.zig`, `image/make-image.sh`, `image/mkfat32.py`, `image/apps.txt`, `tools/verify-live-desktop.sh`, `tools/verify-live-file-browser.sh`, `docs/dogfood-m27.md`
