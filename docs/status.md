...
| Forty-one — test separation & de-monolithization | Unified parallel `zig build test`, shared test mocks (`uaccess_mock`, `task_mock`, `event_mock`, `fb_mock`), decoupled tests from oversized source files | 🔄 in progress (umbrella #951, [GH milestone 28](https://github.com/drawmeanelephant/DipshitOS/milestone/28), cards TS1–TS6) — [`docs/march-m41-test-separation.md`](march-m41-test-separation.md) |
...
- **M41 — In-Tree Test Separation & Source De-monolithization** ([GH milestone 28](https://github.com/drawmeanelephant/DipshitOS/milestone/28); detail tracker: [`docs/march-m41-test-separation.md`](march-m41-test-separation.md), umbrella #951) — in progress: TS1 unified test architecture & shared mock library landed (claim #958, parallel `zig build test` 53/53 passed).
