...
16. ~~**Milestone five, card N1 — virtio-net transport + TX (the roadmap's
    ...
    fixed host MAC; the default VM stays byte-identical — the full 29-gate
    `verify-vz` aggregate re-ran green). Guest `kernel/src/virtio_net.zig`
