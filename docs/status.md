...
| **M73 — Terminal depth** | In flight: index #1624 + 14 cards; acceptance #1638 closes it. Merged: M73a-1, M73f-1, M73b (#1647), M73a-2 (#1649), M73f-2 (#1651), M73c (#1627). Open claim: M73e #1629 (this PR closes it). Claimable now: M73g #1633, M73h #1634, M73j #1636; M73i #1635 and M73k #1637 unblock when #1629 merges. Wave 2 (TTF grid, palette theming) not yet filed. | #1624 |
