...
| **M73 — Terminal depth** | In flight: index #1624 + 14 cards; acceptance #1638 closes it. Merged: M73a-1, M73f-1, M73b (#1647), M73a-2 (#1649), M73f-2 (#1651), M73c (#1627), M73e (#1652), M73g (#1653), M73h (#1654), M73i (#1656). This PR closes M73k #1637. M73j #1636 is claimed; M73z #1638 after wave 1. Wave 2 filed: M73l #1661 (TTF grid), M73m #1662 (palette theming). | #1624 |
| **M74 — TUI apps** | Split out of M73 wave 2: milestone 55 + index #1639 filed. M74c `GOHELP.ELF` help browser landed (#1646, gate `go-help`). | #1639 |
