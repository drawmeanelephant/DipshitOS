...
| `live-net-offline` | B | `bash tools/verify-live-net-offline.sh` | ✅ pass — M26 N13+N14: offline/no-route fast-exit preflight in PING.BIN/FETCH.BIN (claim 8852); 23/23 across offline boot, no-route boot, online control | 2026-08-28 |
