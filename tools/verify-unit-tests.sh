...
MODULES=(alloc console csprng esp exec exceptions fat gic handoff lineedit machine mailbox memmap mmu monitor nvram_console process scheduler shell syscall timer tokenizer uaccess userspace virtio_blk virtio_custom virtio_entropy)
