...
MODULES=(alloc console esp exceptions fat gic handoff lineedit machine memmap monitor nvram_console scheduler shell timer tokenizer virtio_blk virtio_custom)
