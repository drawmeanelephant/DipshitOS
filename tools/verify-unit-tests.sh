...
MODULES=(alloc arp console csprng esp exec exceptions fat gic handoff ipv4 lineedit machine mailbox memmap mmu monitor nvram_console process scheduler shell syscall timer tokenizer uaccess udp userspace virtio_blk virtio_custom virtio_entropy virtio_net)
