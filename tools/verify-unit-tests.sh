...
MODULES=(alloc console esp exceptions fat gic handoff lineedit machine memmap mmu monitor nvram_console scheduler shell syscall timer tokenizer userspace virtio_blk virtio_custom)
