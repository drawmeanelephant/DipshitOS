...
# ELF rows, M32's ZC.BIN, the M19 sexiburger rows (SEXIBURG.BIN +
# SEXITEST.BIN, 5845d7f), and M36 IMG5's VIEW.BIN (issue #826). `#`
# comments are skipped by parse_manifest.
