...
# The kernel theme table and its hex values stay pinned by A4/B4 (SYSMON)
# and A5/B5 (DEVCONS); lost coverage is the retired notepad's own dark/light
# window pixels only.

# M60 / #1297: A2/B2 (exec EDIT.BIN) retired with the Zig editor.
# M60 / #1374: A3/B3 (exec FILE.BIN) retired with Zig FILE.BIN.
# M62h / #1406: A1/B1 (exec CALC.BIN) retired with Zig CALC.BIN. Remaining
# runs still pin SYSMON/DEVCONS tokens.
