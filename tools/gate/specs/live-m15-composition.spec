...
vgate_assert 01 serial-contains 'chime:\|snd: rearm'
vgate_assert 01 serial-absent 'sound: did=0x0000000000001059'
vgate_assert 01 serial-contains 'chime: info fmt=19 rate=7 ch=2'
vgate_assert 01 serial-contains 'chime: tick 1 seq='
vgate_assert 01 serial-contains 'chime: tick 1 seq=.* chunks=10 played=38400'
vgate_assert 01 serial-contains 'chime: tick 2 seq=.* chunks=10 played=38400'
vgate_assert 01 serial-contains 'chime: tick 3 seq=.* chunks=10 played=38400'
vgate_assert 01 serial-contains 'chime: done'
vgate_assert 01 serial-absent 'tasks user-exec exited status=0'
