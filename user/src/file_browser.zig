...
fn draw_list_row(win: u32, row: usize, name: []const u8, entry: *const DirEntry, is_sel: bool, hl_at: usize, hl_len: usize) void {
...
pub const AppState = struct {
    ...
    fn draw_list(self: *const AppState, win: u32) void {
        ...
        while (i < self.entry_count and row < vis) : ({
            ...
            draw_list_row(win, row, name, entry, is_sel, hl_at, hl_len);
        }
