...
pub const exec_program_args = abi.exec_program_args;
pub const exec_max_args = abi.exec_max_args;
pub const exec_arg_slot_bytes = abi.exec_arg_slot_bytes;
...
pub const sys_time = abi.sys_time;
pub const sys_time_num = abi.sys_time_num;
pub const tty_attach = abi.tty_attach;
pub const sys_tty_attach_num = abi.sys_tty_attach_num;
