//! 8x8 monochrome bitmap font for userland text rendering — public domain.
//!
...
test "user font8x8: source rows are LSB-first with bit zero at the left" {
...
test "user font8x8: the 760-byte table is pinned" {
