...
// The Bubble Tea face of the M74c help browser: a real tea.Model whose
...
// ANSI frame into that bound tty. Like charmhello/pulse/GOFILES, Bubble
// Tea's host Program loop never runs here — main owns the read loop.
package main
