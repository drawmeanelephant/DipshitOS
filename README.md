...
(24 commands, mock-tested) are built; the transcript test gate passes
...
3. **Milestone three is active; tasks, EL0/SVC, and the syscall ABI are
   ...
   uaccess (claim 6120) is done. **Per-task user address spaces is the next
   milestone-three card.** Canonical ordering and evidence live in
   `docs/status.md`.
